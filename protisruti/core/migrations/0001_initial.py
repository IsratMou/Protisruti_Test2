    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('user', 'User'), ('counselor', 'Counselor'), ('admin', 'Admin')], default='user', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization', models.CharField(choices=[('domestic_violence', 'Domestic Violence'), ('sexual_assault', 'Sexual Assault'), ('child_abuse', 'Child Abuse'), ('trauma', 'Trauma'), ('general', 'General Support')], max_length=20)),
